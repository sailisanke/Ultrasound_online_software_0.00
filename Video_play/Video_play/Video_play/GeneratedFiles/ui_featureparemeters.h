...
public:
    ...
    void setupUi(QDialog *featureparemeters)
    {
        ...
        QObject::connect(OK, SIGNAL(clicked()), featureparemeters, SLOT(accept()));
        QObject::connect(Cancle, SIGNAL(clicked()), featureparemeters, SLOT(reject()));
    ...
    void retranslateUi(QDialog *featureparemeters)
    {
        ...
        OK->setText(QApplication::translate("featureparemeters", "OK", 0));
        Cancle->setText(QApplication::translate("featureparemeters", "Cancle", 0));
    } // retranslateUi
